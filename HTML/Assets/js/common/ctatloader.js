/**-----------------------------------------------------------------------------
 $Author: sewall $
 $Date: 2017-06-26 10:10:06 -0400 (Mon, 26 Jun 2017) $
 $HeadURL: svn://pact-cvs.pact.cs.cmu.edu/usr5/local/svnroot/AuthoringTools/branches/CTAT_4_3_Release/HTML5/ctatloader.js $
 $Revision: 24835 $
...
if (window.jQuery) 
{
	$(function()
	{
		...
		initOnload ();
		window.parent.parent.$('.ui-dialog-title').css({'visibility': 'hidden'});
	});
}
else
{
